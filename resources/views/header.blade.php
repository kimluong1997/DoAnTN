		...
		<div class="pull-right beta-components space-left ov">
			...
			<div class="beta-comp">
				...
				<div class="cart">
					...
					<a href="{{route('dathang')}}" class="beta-btn primar text-center">Giỏ hàng (@if(Session::has('cart')){{Session('cart')->TongSL}}@else Trống @endif) <i class="fa fa-chevron-right"></i></a>
					<style>
						.cart {
							border: none;
						}

						a.beta-btn.primar.text-center {
							color: #FF9933;
							border-color: #FF9933;
							border-radius: 8px;
							height: 37px;
						...
						a.beta-btn.primar.text-center:hover {
...
<div class="header-bottom" style="background-color: #FF9933; padding: 10px; height: 64px;">
	<div class="container">
		...
		<nav class="main-menu">
			<ul class="l-inline ov">
				...
				<li><a style="color: black ;font-size: 20px ;font-weight: bold; font-style: normal;"> <b> Danh mục sản phẩm</b></a>
					<ul class="sub-menu">
				...
				<div class="container">
					...
					<div class="pull-right auto-width-right">
						<ul class="top-details menu-beta l-inline">
							...
							@if(Auth::check())
							<li>
								<button class="auth"><a href="" style="color: white">Chào {{Auth::user()->name}}</a></li></button>
							<li><button class="auth"><a href="{{route('dangxuat')}}" style="color: white">Đăng xuất</a></button>

							</li>
							@else
							<li><button class="auth"><a href="{{route('dangki')}}" style="color: white">Đăng kí</a></li></button>
							<li><button class="auth"><a href="{{route('dangnhap')}}" style="color: white">Đăng nhập</a></li></button>
							@endif
