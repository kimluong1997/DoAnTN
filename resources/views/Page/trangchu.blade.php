						       ...
						       <div id="owl-demo" class="owl-carousel">
							        ...
							        <div class="item-owl">
					                		<div class="test-review">
						                	  <img src="source/image/slide/{{$sl->Hinh}}" class="img-responsive" alt=""
								...
								<div class="col-sm-3">
									...
									@endif
										...
										<div class="single-item-caption">
											<a class="add-to-cart pull-left" href="{{route('themgiohang',$moi->id)}}"><i class="fa fa-shopping-cart"></i></a>
