							...
							<div class="col-sm-4">
								<div class="single-item">
									<div class="single-item-header">
										<a href="product.html"><img src="source/image/product/{{$sp->img}}" alt="" height="220px" width="260px"></a>
									</div>
									<div class="single-item-body">
										<p class="single-item-title">{{$sp->TenSP}}</p>
										<p class="single-item-price">
											<span>{{number_format($sp->DonGia)}} đồng</span>
										</p>
									</div>
									<div class="single-item-caption">
										<a class="add-to-cart pull" href="shopping_cart.html"><i class="fa fa-shopping-cart"></i></a>
